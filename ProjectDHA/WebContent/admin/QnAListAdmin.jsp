...
List<BoardVO> qnaList = (List<BoardVO>)request.getAttribute("printList");
%>
<body>
...
%>
			<tr>
				<td class="qnaTitle"> <a href="<%=request.getContextPath()%>/boardDetailAdmin.do?board_no=<%= board.getBoard_no()%>"> <%= board.getBoard_title()%> </a></td>
				<%-- <td class="qnaTitle" id="<%= board.getBoard_no() %>"><%= board.getBoard_title() %></td> --%>
				<td class="qnaContent"><%= board.getBoard_content() %></td>
				<td class="qnaWriter"><%= board.getMem_id() %></td>
				<td class="qnaDate"><%= board.getBoard_date() %></td>
			</tr>	
<%
			}
		} else{%>

...
$(function(){
	...
	$('#logo').on('click', function(){
		location.href="/ProjectDHA/main/main.jsp";
	})
	...
	$('#sp4p2').on('click', function(){
		location.href="/ProjectDHA/cart/cartMain.jsp";
	})
	
	// 공지사항	
	$('#sp5p1').on('click', function(){
		location.href="/ProjectDHA/noticeList.do?p=p1";
	})
	...
	$('#sp5p3').on('click', function(){
		location.href="/ProjectDHA/board/oftenQuestion.jsp?p=p3";
	})

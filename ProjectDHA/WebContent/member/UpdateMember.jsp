...
<body>
	<div id="profile">
		<form id="ff" enctype="multipart/form-data" action="/ProjectDHA/updateMember.do?mem_id=<%=memberVo.getMem_id() %>" method="post">
			...
			<hr>
			<p><label>전화번호  </label><span><input type="text" name="mem_tel" id="mem_tel" value="<%=memberVo.getMem_tel() %>"> </span></p>
			<hr>
			<p><label>생년월일  </label><span><input type="date" name="mem_bir" value="<%=memberVo.getMem_bir() %>"> </span></p>
			<hr>
			<p><label>비밀번호   </label><span><input type="password" name="mem_pass" value="<%=memberVo.getMem_pass() %>"></span></p>
			<hr>

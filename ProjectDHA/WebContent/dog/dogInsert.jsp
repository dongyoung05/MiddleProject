...
<body>
	...
	<div id="profile">
		<form  id="ff" action="/ProjectDHA/dogInsert.do?mem_id=<%=memberVo.getMem_id() %>" method="post" enctype="multipart/form-data"  >
		    <h1 style="text-align: center;">반려견 정보 등록</h1>
			
			<label></label><input type="text" placeholder="반려견 이름을 입력하세요" name="dog_name"><br>
			<label></label><input type="text" placeholder="반려견 종을 입력하세요" name="dog_breed"><br>
			<label>성별 </label> <select name = "dog_gender">
								    <option>남</option>
								    <option>여</option>
								
			  				</select><br>
			<label>생일 </label> <input type="date" placeholder="반려견 생일을 입력하세요" name="dog_birth"><br>

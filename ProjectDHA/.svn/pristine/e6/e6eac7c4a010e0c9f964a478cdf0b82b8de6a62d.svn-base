...
<link href="<%=request.getContextPath() %>/css/Modal창.css" rel="stylesheet">
<style>
	body {
...
<script>
  	...
  	$(function() {
  		...
  		$('#boardlist').on('click', function(){
  			location.href = "<%= request.getContextPath()%>/printListAdmin.do?ctgry=QUES";
  		});
	    ...
	    $('#reply_update').click(function() {
	        ...
	        reply_content1 = $('#reply_content1').val();
				...
				code += `<div class="reply-body">
							<table class="body">
								...
								<tr class="reply-p1">
									...
									<td>
										<span class="writer">${v.reply_writer}</span> &nbsp;&nbsp;&nbsp;
									</td>
									
									<td>
										작성일: <span class="date">${v.reply_date}</span>
									</td>
							...
							code+= `</table>`;
						 	code +=		` <p class="reply-p3" style="text-align:center; ">
								<input idx="${v.reply_no}" type="button"  value="답변수정" name="reply_update" class="reply_update"
						            		...
						            		margin-right: 10px;"
								>`;	
						code +=				`<input idx="${v.reply_no}" type="button"  value="답변삭제" name="reply_delete" class="reply_delete"
...
<div class="container">
    ...
    <div class="container">
    	...
    	<div class="replyInsert">
    		...
    		<button id="reply_button">답변등록</button>
    		</div>
     	</div>
    </div>
    <% } %>
    ...
    <div class="container">
    	<div class="replyView">
    		<h2 style="padding: 10px 0 15px 0; border-bottom: 1px solid gray;">문의에 대한 답변</h2>
    		<div class="datView" >
	...
	<div class="modal_container" style="margin: none;">
		<div class="modal">
			...
			<form id="ff">
				...
				<p>
					<span class="modalSpan">내용</span>
					<textarea rows="20" cols="50" id="reply_content1" style=""></textarea>
				</p>
			</form>
			</div>
			<hr>
			...
			<div class="modal_footer">
				<button id="reply_update">수정하기</button>
